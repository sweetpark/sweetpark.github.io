...
- [(트랜잭션 #1) @Transactional 프록시 생략으로 인한 Rollback 실패 사례](../../개발%20(CS)/데이터베이스/트랜잭션/[트랜잭션%20%231]%20@Transactional%20프록시%20생략으로%20인한%20Rollback%20실패%20사례.md) — 동일한 예외 처리·자기호출 트랩 사례를 다루는 자매 노트(리플렉션 직접 호출 케이스 추가 수록)
