...
- [(Spring Batch) 대용량 비즈니스 거래 대사·정산 배치 아키텍처와 장애 복구 패턴](../아키텍처·설계/[Spring%20Batch]%20대용량%20데이터%20대사·정산%20배치%20아키텍처와%20장애%20복구%20패턴.md) — 1절 대외 파일 수집(SFTP) 단계에서 이 무상태 서비스 + Connection 값객체 패턴이 실제로 쓰이는 배치 파이프라인 사례
