---
title: "[배포 #1] GitHub Actions를 이용한 배포 (CI/CD 파이프라인 , 무중단배포 X)"
tags: [토이프로젝트, 배포]
created: 2026-09-05
modified: 2026-09-05
---

# [배포 #1] GitHub Actions를 이용한 배포 (CI/CD 파이프라인 , 무중단배포 X)
...
- [[배포 #2] WAR & JAR 차이](../영화예매%20프로젝트/[배포%20%232]%20WAR%20&%20JAR%20차이.md) — 같은 "배포" 넘버링 시리즈의 다른 편으로, Docker 없이 WAR/JAR을 직접 빌드해 배포하는 방식을 다룸
