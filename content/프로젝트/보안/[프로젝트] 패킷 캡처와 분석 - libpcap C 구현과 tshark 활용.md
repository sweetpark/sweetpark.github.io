...
- [(Bash) pcap 예제 - 핵심 개념 및 특징 정리](../../개발%20(CS)/네트워크/[Bash]%20pcap%20예제%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 프로젝트의 예제 코드를 정리한 노트(해당 노트에서 이 프로젝트로 역링크 존재)
- [(TCP_IP) libpcap 함수 - 핵심 개념 및 특징 정리](../../개발%20(CS)/네트워크/[TCP_IP]%20libpcap%20함수%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 프로젝트가 실제로 사용한 `pcap_findalldevs`/`pcap_open_live`/`pcap_loop` 등 libpcap 함수의 레퍼런스
