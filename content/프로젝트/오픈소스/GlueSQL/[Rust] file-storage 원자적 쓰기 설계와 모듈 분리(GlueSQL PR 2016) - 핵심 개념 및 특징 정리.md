...
- [(Rust) 오픈소스 컨트리뷰션 실전 가이드(이슈 찾기부터 PR 작성까지, GlueSQL 사례) - 핵심 개념 및 특징 정리]([Rust]%20오픈소스%20컨트리뷰션%20실전%20가이드(이슈%20찾기부터%20PR%20작성까지,%20GlueSQL%20사례)%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 PR을 "방법으로 실제 기여 항목을 찾아 적용한 사례"로 인용하는 오픈소스 기여 가이드
