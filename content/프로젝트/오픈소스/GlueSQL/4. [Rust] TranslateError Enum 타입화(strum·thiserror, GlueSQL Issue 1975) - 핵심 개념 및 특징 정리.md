...
- [(Rust) CREATE TABLE 옵션 거부(early-return 검증, GlueSQL #1972) - 핵심 개념 및 특징 정리](3.%20[Rust]%20CREATE%20TABLE%20옵션%20거부%28early-return%20검증,%20GlueSQL%20PR%201972%29%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 리팩터링의 배경이 된 선행 PR
...
- [(Rust) 오픈소스 컨트리뷰션 실전 가이드(이슈 찾기부터 PR 작성까지, GlueSQL 사례) - 핵심 개념 및 특징 정리](2.%20[Rust]%20오픈소스%20컨트리뷰션%20실전%20가이드(이슈%20찾기부터%20PR%20작성까지,%20GlueSQL%20사례)%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 노트를 "스코프를 넓혀 처리한 실제 예"로 인용하는 오픈소스 기여 가이드
- [(Rust) 오픈소스 PR 리뷰 대응기(CodeRabbit, GlueSQL PR 2016) - 핵심 개념 및 특징 정리](7.%20[Rust]%20오픈소스%20PR%20리뷰%20대응기%28CodeRabbit,%20GlueSQL%20PR%202016%29%20-%20핵심%20개념%20및%20특징%20정리.md) — 이 노트를 "사람 리뷰 대응 사례"로 인용하는 PR #2016 리뷰 대응기
