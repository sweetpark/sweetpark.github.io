...
---
## 🔗 관련
- [소수 찾기](../구현/소수%20찾기.md) — 소수 판별(에라토스테네스의 체) 비교
- [(Algorithm) 소수찾기 - 핵심 개념 및 특징 정리](../구현/[Algorithm]%20소수찾기%20-%20핵심%20개념%20및%20특징%20정리.md) — DFS로 후보 생성 + 소수 판별 동일 패턴
- [(DFS) 깊이우선탐색]([DFS]%20깊이우선탐색.md) — DFS 재귀 탐색 개념
