...
- [(DFS) 깊이우선탐색]([DFS]%20깊이우선탐색.md) — DFS 완전탐색 개념 원류
- [(Algorithm) 60일 계획 - 핵심 개념 및 특징 정리](../기획/[Algorithm]%2060일%20계획%20-%20핵심%20개념%20및%20특징%20정리.md) — 41~60일차 학습 커리큘럼에서 참조하는 문제
- [(Algorithm) 프로그래머스 260516 계획 - 핵심 개념 및 특징 정리](../기획/[Algorithm]%20프로그래머스%20260516%20계획%20-%20핵심%20개념%20및%20특징%20정리.md) — Phase 1 완전 탐색 초급 문제로 참조
