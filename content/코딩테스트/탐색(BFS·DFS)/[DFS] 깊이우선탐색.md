...
> [!NOTE]
> 특정 백준/프로그래머스 문제에 종속되지 않은 일반 이론 정리 노트입니다. DFS의 개념·핵심 이론·기본 구현을 다룹니다. 실전 적용 예시는 아래 관련 문서(백준 11724번, 백준 13023번 등)를 참고하세요.
...
---
## 🔗 관련
- [(DFS) 백준 11724번]([DFS]%20백준%2011724번.md) — DFS로 연결 요소 개수 세기
- [(DFS) 백준 13023번]([DFS]%20백준%2013023번.md) — DFS 깊이 제한 탐색 + 백트래킹
- [(DFS) 백준 2023번]([DFS]%20백준%202023번.md) — DFS로 자릿수 생성 + 소수 판별
- [(BFS·DFS) 백준 1260번]([BFS·DFS]%20백준%201260번.md) — DFS/BFS 기본 구현 비교
- [(Algorithm) 네트워크 - 핵심 개념 및 특징 정리]([Algorithm]%20네트워크%20-%20핵심%20개념%20및%20특징%20정리.md) — DFS 연결 요소(Connected Components)
- [(Algorithm) 타겟넘버 - 핵심 개념 및 특징 정리]([Algorithm]%20타겟넘버%20-%20핵심%20개념%20및%20특징%20정리.md) — DFS 완전탐색(상태 분기)
- [(Algorithm) 소수찾기 - 핵심 개념 및 특징 정리](../구현/[Algorithm]%20소수찾기%20-%20핵심%20개념%20및%20특징%20정리.md) — DFS 순열 생성 + 백트래킹
- [(Algorithm) N과 M(1) - 핵심 개념 및 특징 정리](../구현/[Algorithm]%20N과%20M%281%29%20-%20핵심%20개념%20및%20특징%20정리.md) — DFS 백트래킹 기본형
