...
---
## 🔗 관련
- [(Algorithm) 소수찾기 - 핵심 개념 및 특징 정리]([Algorithm]%20소수찾기%20-%20핵심%20개념%20및%20특징%20정리.md) — 소수 판별 방식 비교(에라토스테네스의 체 vs DFS 순열+시행 나눗셈)
- [(DFS) 백준 2023번](../탐색%28BFS·DFS%29/[DFS]%20백준%202023번.md) — 소수 판별(시행 나눗셈) 응용 문제
