...
- [소수 찾기](소수%20찾기.md) — 소수 판별 방식 비교(에라토스테네스의 체 vs DFS 순열+시행 나눗셈)
- [(DFS) 백준 2023번](../탐색%28BFS·DFS%29/[DFS]%20백준%202023번.md) — DFS로 후보를 생성하며 소수를 판별하는 동일 패턴
- [(DFS) 깊이우선탐색](../탐색%28BFS·DFS%29/[DFS]%20깊이우선탐색.md) — DFS/백트래킹 개념 원류
