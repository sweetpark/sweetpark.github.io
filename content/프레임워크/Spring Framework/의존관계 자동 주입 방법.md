...
> [!NOTE] 실행 환경
> 버전 명시 없음 — `@Autowired`, `@Qualifier`, `@Primary` 등 Spring 표준 애노테이션만 사용되어 특정 버전은 확정하기 어렵다.
...
- [(학습/프레임워크/Spring Framework) 스프링 핵심원리 - 핵심 개념 및 특징 정리]([Spring]%20스프링%20핵심원리%20-%20핵심%20개념%20및%20특징%20정리.md) — 같은 DiscountPolicy/AutoAppConfig 예제로 생성자 주입·@Qualifier·@Primary를 더 깊이 다루는 강의 원본 노트
