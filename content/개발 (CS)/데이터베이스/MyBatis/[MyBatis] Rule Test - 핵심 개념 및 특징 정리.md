...
- 규칙기반테스트 이후 작업
    ...
    **SI·레거시·UI 중심 구조**를 전제로 한 **현실적인 다음 단계 로드맵**
    ...
    # 2️⃣ 2단계 — 영향 범위 감지 테스트 (가장 중요한 다음 단계)
    ...
    4️⃣ (선택) 리팩토링 시 단위 테스트
    
    ```
    
    ---
    
    # 6️⃣ 지금 단계에서 “절대 넘지 말아야 할 선”
