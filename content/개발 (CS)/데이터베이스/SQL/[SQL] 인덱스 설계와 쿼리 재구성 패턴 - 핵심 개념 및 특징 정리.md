...
> [!NOTE]
> EXPLAIN으로 병목을 읽는 법, 복합 인덱스의 leftmost-prefix 규칙, "집계 후 JOIN"으로 조인 비용을 줄이는 재구성 패턴, 세션 변수 대신 윈도우 함수를 쓰는 이유를 정리. 기본적인 SARGable 튜닝 기법은 [(SQL) SQL 쿼리 튜닝 방법 - 핵심 개념 및 특징 정리](../../../%EA%B0%9C%EB%B0%9C%20%EC%8B%A4%EB%AC%B4/%EB%B0%B1%EC%97%94%EB%93%9C%C2%B7%EB%8D%B0%EC%9D%B4%ED%84%B0%EC%B2%98%EB%A6%AC/[SQL]%20SQL%20%EC%BF%BC%EB%A6%AC%20%ED%8A%9C%EB%8B%9D%20%EB%B0%A9%EB%B2%95%20-%20%ED%95%B5%EC%8B%AC%20%EA%B0%9C%EB%85%90%20%EB%B0%8F%20%ED%8A%B9%EC%A7%95%20%EC%A0%95%EB%A6%AC.md)에 정리되어 있고, 이 노트는 인덱스 설계·쿼리 구조 재작성에 초점을 맞춘다.
